...
import { OwnerMarketingSegmentsScreen } from "../screens/owner/OwnerMarketingSegmentsScreen";
...
function MainApp() {
  ...
  return (
    <>
      ...
      />
      <Stack.Screen
        name="OwnerMarketingSegments"
        component={OwnerMarketingSegmentsScreen}
        options={{ title: "Segments" }}
      />
      <Stack.Screen
        name="OwnerMarketingTemplates"
        component={OwnerMarketingTemplatesScreen}
        options={{ title: "Templates" }}
      />
      <Stack.Screen
        name="OwnerMarketingWorkflows"
        component={OwnerMarketingWorkflowsScreen}
      ...
      <Stack.Screen name="AdminCalendar" component={AdminCalendarScreen} options={{ title: "Platform calendar" }} />
      <Stack.Screen name="AdminAnalytics" component={AdminAnalyticsScreen} options={{ title: "Platform analytics" }} />
      <Stack.Screen name="AdminSettings" component={AdminSettingsScreen} options={{ title: "Platform settings" }} />
      <Stack.Screen
