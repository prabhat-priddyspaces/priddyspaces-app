...
export default function CustomerSubscriptionsPage() {
  ...
  async function handleManageBilling() {
    ...
    try {
      ...
      setMessage(err instanceof Error ? err.message : "Unable to open billing settings");
    }
  }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {loading ? (
          ...
          <Card className="mt-6 p-6">
            ...
            <Link href="/customer" className="mt-4 inline-flex">
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {subscription.space_public_id ? (
                      <Link href={`/customer/spaces/${subscription.space_public_id}`}>
