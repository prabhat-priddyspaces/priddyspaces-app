...
const customerSections: SidebarSection[] = [
  {
    ...
    items: [
      ...
      { href: "/member/access-passes", icon: QrCode, label: "Access passes" },
      { href: "/member/my-space-qr", icon: QrCode, label: "My Space QR" },
      { href: "/member/directory", icon: Users, label: "Directory" },
      { href: "/member/subscriptions", icon: Star, label: "Memberships" },
      { href: "/member/rewards", icon: Gift, label: "Rewards" },
...
const adminBaseSections: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/access-scanner", icon: ScanLine, label: "Scanner" },
      { href: "/admin/attendance", icon: ClipboardList, label: "Attendance" },
      { href: "/admin/listings", icon: Box, label: "Listings" },
      { href: "/admin/space-types", icon: Shapes, label: "Space types" },
