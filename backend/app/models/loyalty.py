...
class LoyaltyOwnerSetting(PublicIdMixin, TimestampMixin, Base):
    ...
    updated_by_user_id = Column(Integer, ForeignKey("users.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True)
...
class LoyaltyRedemptionLock(PublicIdMixin, TimestampMixin, Base):
    ...
    organization_id = Column(Integer, ForeignKey("organizations.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    tenant_id = Column(Integer, ForeignKey("organizations.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    wallet_id = Column(Integer, ForeignKey("loyalty_wallets.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    priddy_wallet_id = Column(Integer, ForeignKey("priddy_points_wallets.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    ...
    space_id = Column(Integer, ForeignKey("spaces.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
...
class LoyaltyRedemption(PublicIdMixin, TimestampMixin, Base):
    ...
    priddy_wallet_id = Column(Integer, ForeignKey("priddy_points_wallets.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    redemption_lock_id = Column(Integer, ForeignKey("loyalty_redemption_locks.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    booking_request_id = Column(Integer, ForeignKey("booking_requests.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
...
class LoyaltyLedgerEntry(PublicIdMixin, TimestampMixin, Base):
    ...
    campaign_id = Column(Integer, ForeignKey("loyalty_campaigns.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    booking_request_id = Column(Integer, ForeignKey("booking_requests.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    booking_id = Column(Integer, ForeignKey("bookings.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    payment_id = Column(Integer, ForeignKey("payments.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    redemption_id = Column(Integer, ForeignKey("loyalty_redemptions.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
    redemption_lock_id = Column(Integer, ForeignKey("loyalty_redemption_locks.id", ondelete="SET NULL", deferrable=True, initially="DEFERRED"), nullable=True, index=True)
...
class PriddyPointsLedgerEntry(PublicIdMixin, TimestampMixin, Base):
    ...
    id = Column(Integer, primary_key=True)
    wallet_id = Column(Integer, ForeignKey("priddy_points_wallets.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT", deferrable=True, initially="DEFERRED"), nullable=False, index=True)
    entry_type = Column(String(64), nullable=False)
    points = Column(Integer, nullable=False)
    source = Column(String(64), nullable=False)
